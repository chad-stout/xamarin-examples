...
{
	[Service]
	[IntentFilter(new[] { ActionPlay, ActionPause, ActionStop, ActionRestart })]
	public class MamboService : Service, AudioManager.IOnAudioFocusChangeListener
	{
		//Actions
		public const string ActionPlay = "com.xamarin.action.PLAY";
		public const string ActionPause = "com.xamarin.action.PAUSE";
		public const string ActionStop = "com.xamarin.action.STOP";
		public const string ActionRestart = "com.xamarin.action.RESTART";
...
//			player.Completion += (sender, args) => Play();
			player.Completion += HandleCompletion;
		...
		void HandleCompletion (object sender, EventArgs e)
		{
			Stop ();
			Play ();
		}
		...
		private async void Play()
		{
			...
			try {
				...
				Android.Net.Uri path = Android.Net.Uri.Parse("android.resource://" +PackageName + "/" + Resource.Raw.mambo);
				await player.SetDataSourceAsync(ApplicationContext, path);
